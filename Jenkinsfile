        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Alex-C11/Recursos.git'
                }
            }
        }
        stage('Build') {
