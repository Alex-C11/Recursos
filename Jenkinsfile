        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Alex-C11/Recursos.git'
                }
            }
        }
        stage('Build') {
