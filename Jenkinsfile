        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Alex-C11/Recursos.git'
                }
            }
        }
        stage('Build') {
