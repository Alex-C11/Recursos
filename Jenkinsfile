        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Alex-C11/Recursos.git'
                }
            }
        }
        stage('Build') {
